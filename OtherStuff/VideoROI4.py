...
def Car (dir):
   # dos formas de seleccionarse, o se ejecuta Car despues de cada dibujo,
   #o se omite Next, o en una funcion se selecciona el mayor
   if dir == 1:
      print('Up')
   elif dir == 2:
      print('Left')
...
VerdeB1=np.array([45,40,20],np.uint8)# esta seccion ,np.uint8 no se si es necesaria
